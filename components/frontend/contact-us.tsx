...
const ContactUs: React.FC = () => {
  ...
  const employeeLevelOptions = [
    { value: "intern", label: "Management" },
    { value: "junior", label: "Staff" },
    { value: "mid", label: "Corper" },
    { value: "senior", label: "Intern" },
  ]
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white p-6 rounded-2xl shadow">
          ...
          <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <TextInput label="Employee ID" register={register} name="Id" errors={errors} placeholder="11/22/33" />
              <SelectInput
                label="Department"
                register={register}
                name="department"
